...
"#,
    ...
    let expected = "podman run -it --userns=keep-id -w /home/dungeon/mounts-root --rm -p 127.0.0.1:3000:3000 -p 127.0.0.1:8080:8080 -v dungeon-cache:/home/dungeon/.cache -v dungeon-cache:/home/dungeon/.npm -v ~/data:/data:ro -v dungeon-cache:/var/cache/pacman/pkg:ro -v dungeon-cache:deps:rw -v <CWD>:/home/dungeon/mounts-root localhost/dungeon bash";
